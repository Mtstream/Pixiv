...
import org.kyaru.pixiv.service.download.process.impl.*;
import org.kyaru.pixiv.service.utils.requester.RequestClient;

import java.io.File;
import java.util.HashMap;

import static org.kyaru.pixiv.service.download.process.TaskEngine.VOID_TASK;
...
public class TaskPacker {
    ...
    public void handle(TaskItem.ArtworkID artworkID) {
        this.forward(artworkID);
    }
